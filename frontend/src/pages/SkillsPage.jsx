...
export default function SkillsPage({ skills }) {
  return <section aria-labelledby="skills-title">
    ...
    <div className="mb-4"><ChartPanel title="Tecnologias com mais evidências" technologySelection rows={technologyEvidence(skills, 'all')} description="Tecnologias por número de repositórios. Barras maiores representam mais evidências, não maior proficiência." /></div>
